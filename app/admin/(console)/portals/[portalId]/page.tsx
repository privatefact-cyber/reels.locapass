  ...
  const [{ data: portal }, { data: shops, error: shopsError }, { data: reelRows }, { data: portalAdmins }, { data: shopAdmins }] =
    await Promise.all([
      supabase
        ...
        .select("id, name, slug, home_url, tagline, description, status, accent_color, background_color, hero_media_type, hero_media_url, hero_link_url, header_color, header_opacity")
        .eq("id", portalId)
        .maybeSingle(),
      supabase
        .from("locapass_shops")
