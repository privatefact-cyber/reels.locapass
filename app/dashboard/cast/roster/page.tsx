...
import { RosterPrintButton } from "@/components/dashboard/RosterPrintButton";
...
export default async function CastRosterPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between print:hidden">
        <div>
          <Link href="/dashboard/cast" className="text-xs text-slate-500 hover:underline">
            ← キャスト管理に戻る
          </Link>
