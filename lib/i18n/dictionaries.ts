...
const ar: Dictionary = {
  ...
  "shop": {
    ...
    "allCast": "جميع طاقم CAST",
    "noCast": "لا يوجد طاقم CAST مسجل بعد.",
  ...
  "feed": {
    "noNowPosts": "لا توجد منشورات من CAST المتواجدين حاليًا.",
  ...
  "mypage": {
    ...
    "pushDesc": "تلقَّ إشعارات على هذا الجهاز حول نوبات العمل والمشاركات الجديدة من CAST الذين تتابعهم (بما في ذلك الميزات القادمة)."
  },
  "error": {
