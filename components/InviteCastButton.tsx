...
import { inviteCast, type InviteCastState } from "@/app/dashboard/cast/actions";

export function InviteCastButton({ castId, hasLogin }: { castId: string; hasLogin: boolean }) {
  const boundInvite = inviteCast.bind(null, castId);
