    ...
    <section className="relative isolate min-h-[300px] overflow-hidden" style={{ backgroundColor }}>
      ...
      <div className="relative mx-auto flex min-h-[300px] max-w-[1400px] items-end px-6 py-10 md:px-14">
        <div className="max-w-2xl">
          ...
          <Link href={heroLinkUrl || "#portal-feed"} className="mt-6 inline-flex border px-5 py-2.5 text-xs font-semibold tracking-[0.2em] text-main transition hover:bg-white hover:text-black" style={{ borderColor: accentColor }}>
            EXPLORE NOW
          </Link>
        </div>
      </div>
